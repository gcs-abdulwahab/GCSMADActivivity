...
fun Heading(name: String, modifier: Modifier = Modifier) {
  ...
  Column {
      Button(onClick = {
          ...
          val intent = Intent(mContext, DestinationActivity::class.java)
      ...
      AsyncImage(model = "https://cdn.pixabay.com/photo/2015/10/31/12/54/google-1015751_640.png", contentDescription = ""  , modifier = Modifier.padding(16.dp).size(100.dp))
  }
}
